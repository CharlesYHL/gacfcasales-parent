...
public class TiOpiExtended implements Serializable {
	...
	public TiOpiExtended() {
		super();
	}

	public TiOpiExtended(Long PRODUCT_ID, String DEALER_CODE, Long PRODUCT_NO, String PRODUCT_NAME,
