...
import com.gacfcasales.dmsweb.shiro.CustomAuthenticationToken;
...
public class IndexController {
	...
	public Result login(@RequestParam String userName, @RequestParam String password, @RequestParam String dealerCode) {
		...
		try {
			...
			/*
			 * if((System.currentTimeMillis()-subject.getSession().getStartTimestamp().
			 * getTime())>=lengthenTimeOut-1000){
			 * 
			 * }
			 */
	...
	/*
	 * @RequestMapping("/") public String fordPAGE(){ logger.info("请求/"); return
	 * "login"; }
	 */

	/*
	 * @RequestMapping("/index") public String index(){ logger.info("请求首页");
	 * 
	 * return "index"; }
	 */
