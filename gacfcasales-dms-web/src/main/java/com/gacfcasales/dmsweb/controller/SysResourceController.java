...
public class SysResourceController {
	...
	@ResponseBody
	public Result<SysResource> getSysResourceList(SysResource sysResource,
		...
		if (assist.getRowSize() == null) {
			assist.setRequires(Assist.andEq("a.dms_app_id", appKey));
		} else {
	...
	public Result<SysResource> saveOrupdate(@RequestBody SysResource sysResource) {
		...
		try {
			if (sysResource.getId() == null || "".equals(sysResource.getId())) {
				...
				sysResource.setDmsAppId(appKey);
	...
	@ResponseBody
	public String getResourceById(@RequestParam(required = false) String id,
