	...
	<div class="box box-custom collapsed-box" style="margin-bottom:8px;">
		<div v-show="showList" class="box-header with-border form-inline">
			<div class="input-group input-group-sm" style="margin-right:20px;width:220px;">
				<span class="input-group-addon" style="width:30px;">角色名称</span>
				<input type="text" class="form-control" name="name" id="name" value="" placeholder="请输入角色名称"/>
			</div>
			<div class="input-group input-group-sm" style="margin-right:20px;width:220px;">
			...
			<div class="col-xs-offset-1 col-xs-10">
				<div class="panel panel-default">
						...
						<div class="form-group">
						   	...
						   	<div class="col-sm-10">
						      <input type="text" class="form-control" v-model="sysRole.name" placeholder="角色名称"/>
						    </div>
						</div>
						<div class="form-group">
						   	<div class="col-sm-2 control-label">备注</div>
						   	<div class="col-sm-10">
						      <input type="text" class="form-control" v-model="sysRole.description" placeholder="备注"/>
						    </div>
						</div>
						<div class="form-group">
						   	<div class="col-sm-2 control-label">状态</div>
						   	<div class="col-sm-10">
						      <input type="text" class="form-control" v-model="sysRole.status" placeholder="状态"/>
						    </div>
						</div>
						<div class="form-group">
						   	<div class="col-sm-2 control-label">排序号</div>
						   	<div class="col-sm-10">
						      <input type="number" class="form-control" v-model="sysRole.seq" placeholder="排序号"/>
						    </div>
						</div>
						<div class="row">
							<div class="form-group col-sm-12">
								<strong class="col-sm-2 control-label">权限</strong>
								<div class="col-sm-10">
...
<script src="${ctx }/resource/js/sysPage/sysRoleList.js"></script>
