 ...
 * alert(XMLHttpRequest.responseText); } alert('错误',
 * XMLHttpRequest.responseText); }, success: function (XMLHttpRequest,
 * textStatus, errorThrown){ var showRequestText = function(aa){
 * alert(XMLHttpRequest.responseText); } alert('成功',
 * XMLHttpRequest.responseText); }, complete:function(XMLHttpRequest,status){
 * var res = JSON.stringify(XMLHttpRequest.responseText);
 * if(res=="{sessionState:0}") { console.log("123"); }else
 * if(res.indexOf("id=\"container\"")>0){ console.log("456"); }else{
 * console.log("信息:"+XMLHttpRequest.code) console.log("12121"); } } });
 */
