...
var TableInit = function() {
	...
	oTableInit.Init = function() {
		$('#table')
				.bootstrapTable(
						{
							url : ctx + '/dcsProfit/ajax/getProfitList',
							method : 'POST',
...
function exportExcel() {
	...
	window.location.href = ctx + '/dcsProfit/ajax/exportProfitExcel?BIG_ORG='
...
function detail(productSalesId){
	if(productSalesId != '' ){
		globe_index = layer.open({
			...
			fixed : true, // 固定
			maxmin : false,
			content : ctx + '/dcsProfit/ajax/detailProfit?PRODUCT_SALES_ID='+productSalesId
		});
	}
}
