var Dashboard = function() {
    return {
        ...
        initCharts: function(repair_data) {
            if (!jQuery.plot) {
                return;
            }
                ...
                $("#site_activities").bind("plothover", function(event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                            ...
                            var x = item.datapoint[0].toFixed(2),
                                y = item.datapoint[1].toFixed(2);
                            showChartTooltip(item.pageX, item.pageY, item.datapoint[0], item.datapoint[1] + '台');
                        }
                    }
                });
        ...
        initAmChart5:function(_graphs,_dataProvider) {
