...
import com.gacfcasales.dcsweb.shiro.UrlPermissionsAuthorizationFilter;
...
public class SysResourceController {
	...
	public List<SysResource> getMenu(){
		...
		TcUser tcUser = (TcUser) subject.getSession().getAttribute("users");
		WhereRequire<Long> require = Assist.andEq("rr.role_id", tcUser.getRoleId());
